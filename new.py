...
os.system('clear')
psb('\x1b[1;32mBANGLADESH SHOPON 11 DIGIT CLONING START PLEASE WAIT ..........')
for n in range(9999):
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : 'SHAHARIAR SHOPON'
    print 'FACEBOOK : SHAHARIAR SHOPON'
    print 'GITHUB     : github.com/SHOPONKHAN775'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
